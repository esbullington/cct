...
from covidconnection.rsa import pkcs1
from covidconnection import ntp
from micropython import const

SCOPE_USERINFO_EMAIL = const("https://www.covidconnectionapis.com/auth/userinfo.email")
SCOPE_FIREBASE_DATABASE = const("https://www.covidconnectionapis.com/auth/firebase.database")
SCOPE_SPREADSHEETS = const("https://www.covidconnectionapis.com/auth/spreadsheets")
...
# see https://developers.covidconnection.com/identity/protocols/OAuth2ServiceAccount
class JWTBuilder:
    ...
    def __init__(self):
        ...
        self._claim = {
            'iss': '',
            'scope': '',
            'aud': 'https://www.covidconnectionapis.com/oauth2/v4/token',
            'exp': 0,
            'iat': 0}
        self._key = None
...
class ServiceAccount:
    ...
    def token(self):
        ...
        response = requests.post('https://www.covidconnectionapis.com/oauth2/v4/token',
                                 data=body,
                                 headers=headers)
        if not response:
